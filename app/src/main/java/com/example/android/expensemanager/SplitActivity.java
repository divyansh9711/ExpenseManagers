...

{
    ...
    private static final String LOG_TAG = SplitActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(SplitActivity.this, "Wanna change photo?", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser()==null){
                    startActivity(new Intent(SplitActivity.this, LoginActivity.class));
                    finish();
                }
            }
        };
        ...
        listViewMain.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SplitActivity.this, AddExpense.class);
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long arg3) {
                ...
                mActiveLists.child(listKeySelected).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        else Toast.makeText(SplitActivity.this, "Only list owner can edit the list.", Toast.LENGTH_SHORT).show();
                    }
    ...
    public void startProgressDialog(){
        ...
        progressDialog = ProgressDialog.show(SplitActivity.this, "Just a minute", "Populating the lists...", false,
                true, new DialogInterface.OnCancelListener() {

                    @Override
                    public void onCancel(DialogInterface dialog) {
//                        if (listAdapter.isEmpty())
//                            Toast.makeText(SplitActivity.this, "Start with a new List.", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        Runnable progressRunnable = new Runnable() {
            ...
            public void run() {
                if (progressDialog != null && progressDialog.isShowing()) {
                    progressDialog.dismiss();
                    Toast.makeText(SplitActivity.this, "There might be some error...", Toast.LENGTH_SHORT).show();
                }
            }
        };
    ...
    public void deleteRenameList(int position){
        ...
        final AlertDialog alert = new AlertDialog.Builder(SplitActivity.this).create();
        final ListView del = new ListView(SplitActivity.this);
        del.setAdapter(new ArrayAdapter<>(SplitActivity.this, android.R.layout.simple_list_item_1, new String[]{"Delete", "Rename"}));
        alert.setView(del);
...
//                            });
                    ...
                    Toast.makeText(SplitActivity.this, listNameSelected + " Deleted", Toast.LENGTH_SHORT).show();
                    alert.dismiss();
                } else {
                    alert.dismiss();
                    AlertDialog.Builder alert1 = new AlertDialog.Builder(SplitActivity.this);
                    alert1.setMessage("Enter list name here");
                    final EditText inputText = new EditText(SplitActivity.this);
                    ...
                    alert1.setPositiveButton("Rename", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            if (!newName.equals("")) {
                                ...
                                Toast.makeText(SplitActivity.this, "Enter a name", Toast.LENGTH_SHORT).show();
                        }
                    });
                    alert1.show();
                }
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                            ...
                            if(OWNER_PHOTO_URL!=null) Picasso.with(SplitActivity.this).load(OWNER_PHOTO_URL).resize(144,144).into(userImage);
                        }
                    }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            super.onBackPressed();
            ActivityCompat.finishAffinity(SplitActivity.this);
        }
    }
